                                                                    ...
                                                                    <div class="post--info">
                                                                        ...
                                                                        <div class="title">
                                                                            <h2 class="h3" style="color:black"><a
                                                                                    href=""
                                                                                    class="btn-link">Thợ khóa vướng tù oan vì quá tài năng</a></h3>
                                                                        </div>
                                                                    </div>

                                                                    <div class="post--content">
                                                                        <p>MỸ-Vụ cướp ngân hàng đầu tiên của Mỹ vô tình khiến cuộc đời thợ khóa Patrick Lyon chao đảo. Vì tài năng được mệnh danh"có một không hai", anh trở thành nghi phạm duy nhất.</p>
                                                                    </div>
