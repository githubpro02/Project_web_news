			...
			<div class="container">
				...
				<div class="float--right float--xs-none text-xs-center">
					...
					<ul class="header--topbar-social nav hidden-sm hidden-xxs">
						<li><a href="https://www.facebook.com/profile.php?id=100024515460327"><i class="fa fa-facebook"></i></a></li>
						<li><a href="https://www.facebook.com/profile.php?id=100024515460327"><i class="fa fa-twitter"></i></a></li>
						<li><a href="https://www.facebook.com/profile.php?id=100024515460327"><i class="fa fa-google-plus"></i></a></li>
						<li><a href="https://www.facebook.com/profile.php?id=100024515460327"><i class="fa fa-rss"></i></a></li>
						<li><a href="https://www.facebook.com/profile.php?id=100024515460327"><i class="fa fa-youtube-play"></i></a></li>
					</ul>
		...
		<div class="container">
			<div style=" padding: 15px 0; display: flex;" class=" row">
				<div class="col-md-4">
					...
					<p>
						<i class="fa fa-map"></i>
						<span style="font-size: 14px" class="block">Yên Nghĩa - Hà Đông - Hà Nội.</span>
					</p>
				</div>
				<div class="col-md-4">
					<p>
						<i class="fa fa-envelope-o"></i>
						<span style="font-size: 14px" class="block">20010783@st.phenikaa-uni.edu.vn</span>
					</p>
					<p>
						<i class="fa fa-phone"></i>
						<span style="font-size: 14px" class="block">+123 456 (789)</span>
					</p>
				</div>
				<div class="col-md-4">
					<p>
						<small style="font-size: 14px" class="block">&copy; 2024 phát triển bởi <a href="#">Nguyễn Đức Mạnh</a>. All Rights Reserved.</small>
						<p>
